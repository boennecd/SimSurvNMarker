...
#>     0%    25%    50%    75%   100% 
#> 0.0557 1.9755 3.3869 5.1505 9.8009
...
#> $Psi
#>         [,1]    [,2]    [,3]    [,4]    [,5]    [,6]
#> [1,]  3.1165  0.1593 -0.3094  1.1234  0.0165  0.8455
#> [2,]  0.1593  1.9999 -0.3191 -0.0909 -0.0431 -0.8120
#> [3,] -0.3094 -0.3191  2.9963 -0.3562  0.0490  0.0866
#> [4,]  1.1234 -0.0909 -0.3562  1.0633  0.4745 -0.2758
#> [5,]  0.0165 -0.0431  0.0490  0.4745  2.5254  0.0210
#> [6,]  0.8455 -0.8120  0.0866 -0.2758  0.0210  1.8012
#> 
#> $Sigma
#>        [,1]   [,2]
#> [1,] 0.0484 0.0000
...
#> 
#>   n= 11118, number of events= 972 
#> 
#>      coef exp(coef) se(coef)     z Pr(>|z|)    
#> Y1 0.2843    1.3289   0.0309  9.19   <2e-16 ***
#> Y2 0.4832    1.6213   0.0358 13.49   <2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#>    exp(coef) exp(-coef) lower .95 upper .95
#> Y1      1.33      0.753      1.25      1.41
#> Y2      1.62      0.617      1.51      1.74
#> 
#> Concordance= 0.646  (se = 0.009 )
#> Likelihood ratio test= 305  on 2 df,   p=<2e-16
#> Wald test            = 303  on 2 df,   p=<2e-16
#> Score (logrank) test = 302  on 2 df,   p=<2e-16
```
