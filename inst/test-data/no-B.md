...
#> 1  0  0  1  1      0.344 3.43  TRUE  1
#> 2  1  1  1  1      0.999 5.54  TRUE  2
#> 3  1  1  1  0      1.240 7.60 FALSE  3
#> 4  1  0  0  1      0.247 8.57  TRUE  4
...
#> 1     0.707 -1.187 -0.6774  1.2201  0  1  1  1  1
#> 2     2.448 -1.223 -0.8644  0.9657  0  1  1  1  1
#> 3     2.848  0.412 -0.4768  0.4690  1  1  1  1  2
#> 4     3.355 -0.114 -0.5799  0.7326  1  1  1  1  2
#> 5     4.131  0.383  0.1429  0.5038  1  1  1  1  2
#> 6     4.462  0.123 -0.2854  0.9292  1  1  1  1  2
#> 7     2.477 -1.190  0.2983 -0.0365  0  0  1  0  3
#> 8     3.729 -0.626 -0.6280 -0.0972  0  0  1  0  3
#> 9     4.707 -1.280 -0.0714 -0.1979  0  0  1  0  3
#> 10    4.850 -0.580 -0.2998 -0.2789  0  0  1  0  3
...
#>     0%    25%    50%    75%   100% 
#> 0.0987 2.1472 3.7732 5.6947 9.9889
...
#> $gamma
#>          [,1]   [,2]   [,3]
#> [1,] -0.00177 -0.217 -0.195
#> [2,] -0.09549 -0.146 -0.178
#> [3,]  0.07747  0.166  0.194
#> [4,]  0.14810 -0.128 -0.178
#> 
#> $B
#>      [,1] [,2] [,3]
#> 
#> $Psi
#>         [,1]    [,2]   [,3]   [,4]    [,5]   [,6]
#> [1,]  2.5781 -0.6194  0.837 -0.627  0.0742  0.433
#> [2,] -0.6194  1.0533 -0.383  0.224  0.0619  0.170
#> [3,]  0.8373 -0.3832  1.160  0.054 -0.3384 -0.118
#> [4,] -0.6275  0.2236  0.054  2.246 -0.1396  0.059
#> [5,]  0.0742  0.0619 -0.338 -0.140  0.7514  0.284
#> [6,]  0.4325  0.1705 -0.118  0.059  0.2837  1.059
#> 
#> $Sigma
#>       [,1]  [,2]  [,3]
#> [1,] 0.101 0.000 0.000
...
#> 
#>   n= 10329, number of events= 4707 
#> 
#>        coef exp(coef) se(coef)     z Pr(>|z|)    
#> Z1 -0.20236   0.81680  0.02931 -6.90  5.1e-12 ***
#> Z2  0.12134   1.12901  0.02930  4.14  3.4e-05 ***
#> Z3 -0.00593   0.99409  0.02927 -0.20   0.8395    
#> Z4 -0.25721   0.77320  0.02938 -8.75  < 2e-16 ***
#> Y1  0.09817   1.10315  0.01673  5.87  4.4e-09 ***
#> Y2 -0.11792   0.88877  0.01985 -5.94  2.8e-09 ***
#> Y3  0.08118   1.08457  0.02523  3.22   0.0013 ** 
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#>    exp(coef) exp(-coef) lower .95 upper .95
#> Z1     0.817      1.224     0.771     0.865
#> Z2     1.129      0.886     1.066     1.196
#> Z3     0.994      1.006     0.939     1.053
#> Z4     0.773      1.293     0.730     0.819
#> Y1     1.103      0.906     1.068     1.140
#> Y2     0.889      1.125     0.855     0.924
#> Y3     1.085      0.922     1.032     1.140
#> 
#> Concordance= 0.564  (se = 0.004 )
#> Likelihood ratio test= 202  on 7 df,   p=<2e-16
#> Wald test            = 202  on 7 df,   p=<2e-16
#> Score (logrank) test = 202  on 7 df,   p=<2e-16
```
