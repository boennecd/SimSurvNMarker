...
#> [1] -0.4  0.5
omega 
#> [1] -1.68 -1.93 -0.62 -5.11 -0.26
delta
#> [1] -0.09 -0.22
beta
#> function (a, b) 
#> .Internal(beta(a, b))
#> <bytecode: 0x5591d9e951c0>
...
Fixed mixed linear mixed model and see that we get the same estimates
...
local({
  ...
  dimnames(Psi) <- NULL
  K <- SimSurvNMarker:::get_commutation(n_y)
